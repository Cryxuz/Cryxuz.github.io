      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[10%] py-[5%]">
            <div>
              {/* hidden md */}
              <div>
               <a href="https://ember-bistro.netlify.app/" target='_blank'><img className="rounded-xl w-[80%] block md:hidden my-[14%]" src="/images/ember.jpg" alt="ember restaurant" /></a> 
              </div>
              {/*  */}
              ...
              {/* hidden 0px */}
              <div>
               <a href="https://ember-bistro.netlify.app/" target='_blank'><img className="rounded-xl hidden md:block" src="images/ember.jpg" alt="ember restaurant" /></a> 
              </div>
              {/*  */}
            </div>
          {/* TODO Project */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[10%] py-[5%]">
          <div>
           <a href="http://paul-tan-to-do-list.devacademy.nz/" target='_blank'><img className="rounded-xl w-[80%]" src="images/todo.jpg" alt="todo project" /></a> 
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[10%] py-[5%]">
            <div>
              {/* hidden md */}
              <div>
               <a href="https://tiffs-donuts.devacademy.nz/" target='_blank'><img className="rounded-xl w-[80%] block md:hidden my-[14%]" src="/images/donut.jpg" alt="donut homepage" /></a> 
              </div>
              {/*  */}
              ...
              {/* hidden 0px */}
              <div>
               <a href="https://tiffs-donuts.devacademy.nz/" target='_blank'><img className="rounded-xl hidden md:block" src="images/donut.jpg" alt="donut homepage" /></a> 
              </div>
              {/*  */}
            </div>
      </div>
