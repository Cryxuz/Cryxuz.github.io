...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="sticky top-0 xl:bg-fixed bg-center bg-cover text-center w-screen h-screen" style={{ backgroundImage: `url(${home})` }}>
      <Navbar />
      <div className="h-screen justify-center pt-[40px] md:pt-[70px] lg:pt-[50px]">
