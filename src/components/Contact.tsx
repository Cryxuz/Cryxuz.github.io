...
export const Contact = () => {
  ...
  return (
    <div className={`w-screen bg-fixed bg-center bg-cover flex items-center justify-center min-h-screen   ${window.innerWidth <= 768 ? 'bg-scale-down' : ''}`} style={{backgroundImage: `url(${footer})`}}>
